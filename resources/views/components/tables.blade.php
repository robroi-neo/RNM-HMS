            ...
            @foreach ($values as $value)
                <tr class="hover:bg-gray-50 border-neutral-200 border-b"
                    ...
                    <td class="flex flex-row px-10 py-4 text-center justify-end space-x-3">
                        <!-- Delete icon -->
                        <a class="text-center px-1 py-0.5"
                            onclick="event.stopPropagation(); deleteRow(@json($value->id));">
                            <svg class="w-6 h-6
                                text-neutral-500 hover:text-neutral-900"
                                viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.78564 6.25H23.2142" stroke="currentColor" stroke-width="2"
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round" />
                                <path d="M9.82129 9.82141V19.6428" stroke="#F9FAFB" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M15.1787 9.82141V19.6428" stroke="#F9FAFB" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </a>
                        <!-- Edit Icon -->
                        <a class="text-center px-1 py-0.5"
                            onclick="event.stopPropagation(); editRow({{ $value }});">
